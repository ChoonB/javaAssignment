...
class Exercise5_1 {
    public static void main(String[] args) {
        //5-1. 다음은 배열을 선언하거나 초기화한 것이다. 잘못된 것을 고르고 그 이유를 설명하세요. 1, 4, 5
//        int[] arr[];                        // int[] arr;나 int arr[];로 해야 한다.
//        int[] arr = {1,2,3,};               // 가능 !!!!!3뒤에 , 를 없에야 한다.<< 라고생각했는데 가능
//        int[] arr = new int[5];             // 가능
//        int[] arr = new int[5]{1,2,3,4,5};  // 불가능 []안에 5빼야됨
//        int arr[5];                         // 불가능 int[] arr = new int[5]
//        int[] arr[] = new int[3][];         // 안될 꺼 같은데 해보니 가능하네;
    }
}
...
class Exercise5_2 {
    public static void main(String[] args) {
        ...
        //5-2. 다음과 같은 배열이 있을 때, arr[3].length의 값은? 2 제일 index 3행의 길이
        int[][]arr ={
                {5,5,5,5,5},
                {10,10,10},
                {20,20,20,20},
